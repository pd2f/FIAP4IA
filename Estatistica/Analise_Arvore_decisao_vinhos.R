...
white_rmoutliers$fator_qualidade <- factor(quality,levels = 3:9,labels = c("Ruim","Ruim","Ruim","Razoável","Bom","Bom","Bom"))
...
par (mfrow=c(3,3))
plot(fixedacidity, fator_qualidade,ylab="Fator Qualidade",xlab="Acidez Fixa",col=c('red','darkgreen'))
plot(volatileacidity, fator_qualidade,ylab="Fator Qualidade",xlab="Acidez Volátil",col=c('red','darkgreen'))
...
Campanha.matriz.de.confusao<-table(white_rmoutliers$fator_qualidade, pred_class)
